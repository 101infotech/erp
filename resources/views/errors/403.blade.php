...
<body class="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 min-h-screen flex items-center justify-center">
    <div class="max-w-2xl mx-auto px-4 text-center">
        ...
        <div class="mb-8">
            <div class="relative">
                <!-- Large 403 Text -->
                <h1
                    class="text-[180px] md:text-[240px] font-black text-transparent bg-clip-text bg-gradient-to-br from-red-400 to-red-600 leading-none select-none opacity-20">
                    403
                </h1>

                <!-- Icon Overlay -->
                <div class="absolute inset-0 flex items-center justify-center">
                    <svg class="w-32 h-32 md:w-40 md:h-40 text-red-500" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
        ...
        <div class="mb-8 space-y-4">
            ...
            <p class="text-lg text-slate-400 max-w-md mx-auto">
                You don't have permission to access this resource. Please contact an administrator if you believe this
                is an error.
            </p>
        </div>
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        ...
        <div class="absolute bottom-20 right-10 w-96 h-96 bg-red-600/5 rounded-full blur-3xl animate-pulse"
