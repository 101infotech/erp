...
<div class="px-6 md:px-8 py-6 space-y-6">
    <!-- Navigation Banner -->
    <div
        class="mb-6 bg-gradient-to-r from-rose-500/10 to-rose-600/10 border border-rose-500/30 rounded-lg p-4 flex items-center justify-between">
        <div class="flex items-center space-x-3">
            <svg class="w-5 h-5 text-rose-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z" />
                <path d="M12 12l2-2" />
            </svg>
            <p class="text-sm text-slate-300"><span class="text-rose-300 font-semibold">Tip:</span> View comprehensive
                lead analytics and KPIs on the dashboard</p>
        </div>
        <a href="{{ route('admin.leads.dashboard') }}"
            class="text-rose-300 hover:text-rose-200 font-medium text-sm flex items-center space-x-2">
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-white">All Leads</h2>
                <p class="text-slate-400 mt-1">View and manage all service leads in the pipeline</p>
            </div>
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('admin.leads.dashboard') }}"
                    class="px-4 py-2 bg-rose-500/10 border border-rose-500/30 text-rose-300 rounded-lg font-medium hover:bg-rose-500/20 transition flex items-center space-x-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <span class="text-lime-400 font-medium">NPR {{ number_format($lead->inspection_charge,
                                    2)
                                    }}</span>
                                @else
