            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="service_requested" name="service_requested" required
                        ...
                        <option value="New Construction" {{ old('service_requested')=='New Construction' ? 'selected'
                        ...
                        <option value="Bathroom Remodel" {{ old('service_requested')=='Bathroom Remodel' ? 'selected'
                            : '' }}>Bathroom Remodel</option>
                        <option value="Deck/Patio" {{ old('service_requested')=='Deck/Patio' ? 'selected' : '' }}>
                            Deck/Patio</option>
                        <option value="Flooring" {{ old('service_requested')=='Flooring' ? 'selected' : '' }}>Flooring
                        </option>
                        <option value="Painting" {{ old('service_requested')=='Painting' ? 'selected' : '' }}>Painting
                        </option>
                        ...
                        <option value="Plumbing" {{ old('service_requested')=='Plumbing' ? 'selected' : '' }}>Plumbing
                        </option>
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" id="inspection_date" name="inspection_date" value="{{ old('inspection_date') }}"
                ...
                <div>
                    ...
                    <input type="text" id="inspection_time" name="inspection_time" value="{{ old('inspection_time') }}"
