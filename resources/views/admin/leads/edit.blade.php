        ...
        <form action="{{ route('admin.leads.update', $lead) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="service_requested" name="service_requested" required
                            ...
                            <option value="{{ $service }}" {{ old('service_requested', $lead->service_requested) ==
                                $service
                                ? 'selected' : '' }}>
                                {{ $service }}
                            </option>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" required
                            ...
                            <option value="{{ $status->status_key }}" {{ old('status', $lead->status) ==
                                $status->status_key
                                ? 'selected' : '' }}>
                                {{ $status->display_name }}
                            </option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="project_size" name="project_size"
                            value="{{ old('project_size', $lead->project_size) }}"
            ...
            <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-4">
                <div class="flex items-center justify-between text-sm text-slate-400">
                    <div>
                        Created by {{ $lead->createdBy->name ?? 'System' }} on {{ $lead->created_at->format('M d, Y h:i
                        A')
                        }}
                    </div>
                    <div>
