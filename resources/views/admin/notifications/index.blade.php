                ...
                <div class="p-5">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            @else
                            <div class="w-12 h-12 rounded-full bg-slate-600/30 flex items-center justify-center">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-slate-400 text-sm mb-3 leading-relaxed">{{ $notification->message }}</p>
                            <div class="flex items-center gap-4">
                                <span class="text-slate-500 text-xs">{{ $notification->created_at->diffForHumans()
                                    }}</span>
