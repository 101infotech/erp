    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
        <form action="{{ route('admin.hrm.expense-claims.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Expense Type -->
                <div>
                    <label for="expense_type" class="block text-sm font-medium text-slate-900 dark:text-slate-300 mb-2">
                ...
                <!-- Expense Date -->
                <div>
                    <label for="expense_date" class="block text-sm font-medium text-slate-900 dark:text-slate-300 mb-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Project Code -->
                <div>
                    <label for="project_code" class="block text-sm font-medium text-slate-900 dark:text-slate-300 mb-2">
                        Project Code
                    </label>
                ...
                <!-- Cost Center -->
                <div>
                    <label for="cost_center" class="block text-sm font-medium text-slate-900 dark:text-slate-300 mb-2">
                        Cost Center
                    </label>
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Upload receipt/invoice for verification</p>
            </div>
