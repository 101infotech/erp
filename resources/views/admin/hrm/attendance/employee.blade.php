        ...
        <table class="min-w-full divide-y divide-slate-700">
            <thead class="bg-slate-900">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-300 uppercase tracking-wider">Payroll
                    </th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-300 uppercase tracking-wider">Overtime
                    </th>
                ...
                <tr class="hover:bg-slate-700/50 transition {{ $isToday ? 'bg-blue-500/10' : '' }}">
                    <td class="px-6 py-3 whitespace-nowrap">
                        <div class="flex items-center gap-2">
                            ...
                            @endif
                            @if($isWeekend)
                            <span class="px-2 py-0.5 text-xs bg-slate-700 text-slate-400 rounded-full">Weekend</span>
                            @endif
                        </div>
                    </td>
                    <td
