...
<div class="px-6 md:px-8 py-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-200 dark:border-slate-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-slate-900 dark:text-white font-medium text-lg">{{ number_format($leave->total_days,
                        1) }}
                        days</p>
                </div>
                <div>
    ...
    <!-- Reject Modal -->
    <x-professional-modal id="rejectModal" title="Reject Leave Request" icon="question" iconColor="red"
        maxWidth="max-w-md">
    ...
    <x-professional-modal id="approveLeaveModal" title="Approve Leave Request" subtitle="Mark this leave as approved"
        ...
        <div class="space-y-4">
            ...
            <div class="bg-slate-900/50 rounded-lg p-3 border border-slate-700">
                ...
                <p class="text-sm text-slate-400 mt-1"><span class="font-medium">Days:</span> {{ $leave->total_days }}
                </p>
            </div>
        </div>
        <x-slot name="footer">
