                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                        ...
                        <p class="text-xs text-blue-200 mt-2">
                            ...
                            Enter the number of days that were approved verbally. These days will be automatically
                            excluded
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="bg-slate-900 border border-slate-700 rounded-lg p-4">
                            ...
                            <p class="text-xl font-semibold text-white">{{ number_format($payroll->total_hours_worked,
                                1) }}
                                hrs</p>
                        </div>
                        <div class="bg-slate-900 border border-slate-700 rounded-lg p-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="hourly_deduction_approved" value="1"
                                id="hourly_deduction_approved" {{ old('hourly_deduction_approved',
                                $payroll->hourly_deduction_approved) ? 'checked' : '' }}
            ...
            <div class="bg-slate-800 rounded-lg p-6 border border-slate-700">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
                        ...
                        <p class="text-2xl font-semibold text-orange-300">NPR {{
                            number_format($payroll->advance_payment, 2)
                            }}</p>
