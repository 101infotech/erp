...
<div class="px-6 md:px-8 py-6">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <form method="POST" action="{{ route('admin.hrm.employees.update', $employee) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="status" required
                                    ...
                                    <option value="inactive" {{ old('status', $employee->status) == 'inactive' ?
                                        'selected'
                                        : '' }}>Inactive</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="department_id" id="department_id"
                                    ...
                                    <option value="{{ $department->id }}"
                                        data-company-id="{{ $department->company_id }}" {{ old('department_id',
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <select name="marital_status"
                                    ...
                                    <option value="single" {{ old('marital_status', $employee->marital_status) ==
                                        'single' ?
                                        'selected' : '' }}>Single</option>
                                    <option value="married" {{ old('marital_status', $employee->marital_status) ==
                                        'married'
                                        ? 'selected' : '' }}>Married</option>
                                    <option value="divorced" {{ old('marital_status', $employee->marital_status) ==
                                        'divorced' ? 'selected' : '' }}>Divorced</option>
                                    <option value="widowed" {{ old('marital_status', $employee->marital_status) ==
                                        'widowed'
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="employment_type"
                                    ...
                                    <option value="intern" {{ old('employment_type', $employee->employment_type) ==
                                        'intern'
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="probation_period_months"
                                    value="{{ old('probation_period_months', $employee->probation_period_months) }}"
                                    min="0" max="12"
                                    class="w-full rounded-lg bg-slate-900 text-white border border-slate-700 px-4 py-2 focus:border-lime-500 focus:outline-none">
                            </div>
                        </div>
                    ...
                    <div x-show="activeTab === 'banking'" x-cloak>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="tax_regime"
                                    value="{{ old('tax_regime', $employee->tax_regime) }}" placeholder="e.g., Old, New"
                                    class="w-full rounded-lg bg-slate-900 text-white border border-slate-700 px-4 py-2 focus:border-lime-500 focus:outline-none">
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="activeTab === 'leaves'" x-cloak>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="casual_leave_balance"
                                    value="{{ old('casual_leave_balance', $employee->casual_leave_balance ?? 0) }}"
                                    min="0" step="0.5"
                                    class="w-full rounded-lg bg-slate-900 text-white border border-slate-700 px-4 py-2 focus:border-lime-500 focus:outline-none">
                            </div>
                            <div>
                                ...
                                <input type="number" name="annual_leave_balance"
                                    value="{{ old('annual_leave_balance', $employee->annual_leave_balance ?? 0) }}"
                                    min="0" step="0.5"
                                    class="w-full rounded-lg bg-slate-900 text-white border border-slate-700 px-4 py-2 focus:border-lime-500 focus:outline-none">
                            </div>
                        </div>
                        <div class="mt-4 p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                            <p class="text-slate-400 text-sm">
                                ...
                                Leave balances are typically managed through leave policies and requests. Manual
                                adjustments
