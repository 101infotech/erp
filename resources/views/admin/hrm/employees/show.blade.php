                ...
                <div x-show="activeTab === 'leaves'" x-cloak>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div class="bg-slate-900 rounded-lg p-4 border border-slate-700">
                            ...
                            <p class="text-2xl font-bold text-white mt-1">{{ $employee->sick_leave_balance ?? 0 }} days
                            </p>
                        </div>
                        <div class="bg-slate-900 rounded-lg p-4 border border-slate-700">
                            <p class="text-slate-400 text-sm">Casual Leave</p>
                            <p class="text-2xl font-bold text-white mt-1">{{ $employee->casual_leave_balance ?? 0 }}
                                days
                            </p>
                        </div>
                        <div class="bg-slate-900 rounded-lg p-4 border border-slate-700">
                            <p class="text-slate-400 text-sm">Annual Leave</p>
                            <p class="text-2xl font-bold text-white mt-1">{{ $employee->annual_leave_balance ?? 0 }}
                                days
                            </p>
                        </div>
                    </div>
