    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
        <form action="{{ route('admin.hrm.resource-requests.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Item Name -->
                <div>
                    <label for="item_name" class="block text-sm font-medium text-slate-900 dark:text-slate-300 mb-2">
                ...
                <div>
                    ...
                    <select name="category" id="category" required
                        ...
                        <option value="pantry" {{ old('category')=='pantry' ? 'selected' : '' }}>Pantry Items</option>
                ...
                <div>
                    ...
                    <input type="number" name="estimated_cost" id="estimated_cost" value="{{ old('estimated_cost') }}"
                        min="0" step="0.01"
