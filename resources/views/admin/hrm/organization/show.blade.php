...
<div class="px-6 md:px-8 py-6 space-y-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-slate-400 text-sm mt-1">{{ $company->employees_count }} Employees • {{
    ...
    <div class="flex justify-end gap-2">
        <a href="{{ route('admin.hrm.organization.companies.edit', $company) }}"
...
<x-professional-modal id="deleteCompanyShowModal" title="Delete Company" subtitle="This action cannot be undone"
    ...
    <x-slot name="footer">
        ...
        <form method="POST" action="{{ route('admin.hrm.organization.companies.destroy', $company) }}" class="inline">
            @csrf
            @method('DELETE')
            <button type="submit"
