...
<div x-data="{ activeNav: null }" @click.away="activeNav = null" class="fixed left-0 top-0 h-screen z-40 flex">
    ...
    <aside class="w-20 bg-slate-900 border-r border-slate-800 flex flex-col">
        ...
        <!-- Navigation Icons -->
        <nav class="flex-1 py-6 flex flex-col items-center space-y-2">

            <!-- Dashboard -->
            <a href="{{ route('dashboard') }}"
                @click.prevent="activeNav = null; window.location.href = '{{ route('dashboard') }}'"
                class="w-12 h-12 flex items-center justify-center rounded-lg transition-colors {{ request()->is('dashboard') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}">
    ...
    <div x-show="activeNav" 
        ...
        <div x-show="activeNav === 'hrm'" class="p-6">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-lg font-semibold text-white">Human Resources</h2>
            ...
            <div x-data="{ open: true }" class="mb-6">
                ...
                <div x-show="open" x-collapse class="mt-2 space-y-1">
                    <a href="{{ route('admin.users.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.hrm.employees.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-data="{ open: true }" class="mb-6">
                ...
                <div x-show="open" x-collapse class="mt-2 space-y-1">
                    ...
                    <a href="{{ route('admin.hrm.expense-claims.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.hrm.expense-claims.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-data="{ open: true }" class="mb-6">
                ...
                <div x-show="open" x-collapse class="mt-2 space-y-1">
                    <a href="{{ route('admin.hrm.leaves.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.hrm.leaves.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.hrm.leave-policies.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.hrm.leave-policies.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div x-show="activeNav === 'finance'" class="p-6">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-lg font-semibold text-white">Finance</h2>
                <button @click="activeNav = null" class="text-slate-400 hover:text-white">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12">
                        </path>
            ...
            <div x-data="{ open: true }" class="mb-6">
                ...
                <div x-show="open" x-collapse class="mt-2 space-y-1">
                    <a href="{{ route('admin.finance.companies.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.companies.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                            </path>
            ...
            <div x-data="{ open: true }" class="mb-6">
                ...
                <div x-show="open" x-collapse class="mt-2 space-y-1">
                    <a href="{{ route('admin.finance.accounts.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.accounts.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.finance.transactions.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.transactions.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-data="{ open: true }" class="mb-6">
                ...
                <div x-show="open" x-collapse class="mt-2 space-y-1">
                    <a href="{{ route('admin.finance.sales.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.sales.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.finance.purchases.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.purchases.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.finance.customers.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.customers.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                            </path>
                    ...
                    <a href="{{ route('admin.finance.vendors.index') }}"
                        class="flex items-center gap-3 px-4 py-2.5 text-sm rounded transition-colors {{ request()->routeIs('admin.finance.vendors.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                            </path>
