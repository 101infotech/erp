...
@section('title', 'Edit Recurring Expense - Finance Management')
...
<div class="container-fluid px-4 py-6 max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Recurring Expense</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update recurring expense schedule</p>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.finance.recurring-expenses.update', $recurringExpense->id) }}" method="POST"
        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" value="{{ $recurringExpense->company->company_name }}" readonly
            ...
            <div>
                ...
                <input type="text" name="expense_name" id="expense_name" required maxlength="255"
                    value="{{ old('expense_name', $recurringExpense->expense_name) }}"
            ...
            <div>
                ...
                <select name="category_id" id="category_id"
                    ...
                    <option value="{{ $category->id }}" {{ old('category_id', $recurringExpense->category_id) ==
            ...
            <div>
                ...
                <input type="number" name="amount" id="amount" step="0.01" min="0" required
                    value="{{ old('amount', $recurringExpense->amount) }}" placeholder="0.00"
            ...
            <div>
                ...
                <select name="frequency" id="frequency" required
                    ...
                    <option value="monthly" {{ old('frequency', $recurringExpense->frequency) == 'monthly' ? 'selected'
                        : '' }}>Monthly</option>
                    <option value="quarterly" {{ old('frequency', $recurringExpense->frequency) == 'quarterly' ?
                        'selected' : '' }}>Quarterly</option>
                    <option value="annually" {{ old('frequency', $recurringExpense->frequency) == 'annually' ?
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="start_date_bs" id="start_date_bs" required
                        value="{{ old('start_date_bs', $recurringExpense->start_date_bs) }}" placeholder="YYYY-MM-DD"
                ...
                <div>
                    ...
                    <input type="text" name="end_date_bs" id="end_date_bs"
                        value="{{ old('end_date_bs', $recurringExpense->end_date_bs) }}"
            ...
            <div>
                ...
                <select name="payment_method" id="payment_method" required
                    ...
                    <option value="cash" {{ old('payment_method', $recurringExpense->payment_method) == 'cash' ?
                        'selected' : '' }}>Cash</option>
                    <option value="bank" {{ old('payment_method', $recurringExpense->payment_method) == 'bank' ?
                        'selected' : '' }}>Bank Transfer</option>
                    <option value="cheque" {{ old('payment_method', $recurringExpense->payment_method) == 'cheque' ?
                        'selected' : '' }}>Cheque</option>
                    <option value="online" {{ old('payment_method', $recurringExpense->payment_method) == 'online' ?
            ...
            <div>
                ...
                <select name="account_id" id="account_id"
                    ...
                    <option value="{{ $account->id }}" {{ old('account_id', $recurringExpense->account_id) ==
                        $account->id ? 'selected' : '' }}>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Next Due Date
                    (BS)</label>
                <input type="text" name="next_due_date_bs" id="next_due_date_bs"
                    value="{{ old('next_due_date_bs', $recurringExpense->next_due_date_bs) }}"
                    placeholder="YYYY-MM-DD (Optional)"
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                <label class="flex items-start gap-3 cursor-pointer">
                    ...
                    <input type="checkbox" name="auto_create_transaction" id="auto_create_transaction" value="1" {{
                        old('auto_create_transaction', $recurringExpense->auto_create_transaction) ? 'checked' : '' }}
            ...
            <div>
                <label class="flex items-center gap-3 cursor-pointer">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active',
                        $recurringExpense->is_active) ? 'checked' : '' }}
