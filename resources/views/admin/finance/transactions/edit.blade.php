        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="company_id" required
                    ...
                    <option value="{{ $company->id }}" {{ old('company_id', $transaction->company_id) == $company->id ?
                        'selected' : '' }}>
                        {{ $company->name }}
                    </option>
                    @endforeach
            ...
            <div>
                ...
                <select name="transaction_type" required
                    ...
                    <option value="transfer" {{ old('transaction_type', $transaction->transaction_type) == 'transfer' ?
            ...
            <div>
                ...
                <select name="payment_method" required
                    ...
                    <option value="card" {{ old('payment_method', $transaction->payment_method) == 'card' ? 'selected' :
                        '' }}>Card</option>
            ...
            <div>
                ...
                <select name="category_id" class="w-full px-4 py-2 border rounded-lg dark:bg-slate-700 dark:text-white">
