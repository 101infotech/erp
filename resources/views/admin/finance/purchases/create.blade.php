...
<div class="max-w-7xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-white">Create Purchase Bill</h2>
    </div>
        ...
        <form action="{{ route('admin.finance.purchases.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="purchase_date_bs" value="{{ old('purchase_date_bs', date('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="number" name="tds_percentage" value="{{ old('tds_percentage', 1.5) }}" step="0.01"
                        min="0" class="w-full px-4 py-2 border rounded-lg dark:bg-slate-700 dark:text-white"
                        placeholder="1.5">
