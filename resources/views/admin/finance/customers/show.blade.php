...
<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
            ...
            <div class="text-2xl font-bold text-slate-900 dark:text-white mt-2">NPR {{ number_format($totalSales, 2) }}
            </div>
        </div>
        <div class="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
            <div class="text-green-600 dark:text-green-400 text-sm font-medium">Paid</div>
            <div class="text-2xl font-bold text-slate-900 dark:text-white mt-2">NPR {{ number_format($paidSales, 2) }}
            </div>
        </div>
