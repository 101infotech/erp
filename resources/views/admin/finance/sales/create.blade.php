        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="sale_number"
                    value="{{ old('sale_number', 'SALE-' . str_pad(rand(1, 999999), 6, '0', STR_PAD_LEFT)) }}" required
            ...
            <div>
                ...
                <input type="text" name="invoice_number" value="{{ old('invoice_number') }}"
                    class="w-full px-4 py-2 border rounded-lg dark:bg-slate-700 dark:text-white" placeholder="INV-001">
