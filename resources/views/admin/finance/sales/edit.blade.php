    ...
    <form action="{{ route('admin.finance.sales.update', $sale) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="sale_date_bs" value="{{ old('sale_date_bs', $sale->sale_date_bs) }}" required
                    class="w-full px-4 py-2 border rounded-lg dark:bg-slate-700 dark:text-white">
            ...
            <div>
                ...
                <select name="customer_id" class="w-full px-4 py-2 border rounded-lg dark:bg-slate-700 dark:text-white">
            ...
            <div>
                ...
                <input type="number" name="taxable_amount" value="{{ old('taxable_amount', $sale->taxable_amount) }}"
            ...
            <div>
                ...
                <input type="number" name="vat_amount" value="{{ old('vat_amount', $sale->vat_amount) }}" step="0.01"
            ...
            <div>
                ...
                <input type="number" name="net_amount" value="{{ old('net_amount', $sale->net_amount) }}" step="0.01"
                    min="0" required class="w-full px-4 py-2 border rounded-lg dark:bg-slate-700 dark:text-white">
            ...
            <div>
                ...
                <select name="payment_status" required
                    ...
                    <option value="pending" {{ old('payment_status', $sale->payment_status) == 'pending' ? 'selected' :
                        '' }}>Pending</option>
                    <option value="partial" {{ old('payment_status', $sale->payment_status) == 'partial' ? 'selected' :
                        '' }}>Partial</option>
