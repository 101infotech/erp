...
<div class="max-w-7xl">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('admin.finance.founder-transactions.index') }}" class="group">
            <svg class="w-6 h-6 text-slate-400 group-hover:text-white transition-colors" fill="none"
                stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
            </svg>
        </a>
        <h2 class="text-2xl font-bold text-white">Record Founder Transaction</h2>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6">
        ...
        <form action="{{ route('admin.finance.founder-transactions.store') }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="finance_founder_id" required
                        ...
                        <option value="{{ $founder->id }}" {{ old('finance_founder_id',
                            request('founder_id'))==$founder->id
                            ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="transaction_type" required
                        ...
                        <option value="investment" {{ old('transaction_type')=='investment' ? 'selected' : '' }}>
                            Investment
                        </option>
