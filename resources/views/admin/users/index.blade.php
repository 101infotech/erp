                            ...
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <div class="relative inline-block">
                                    <button type="button"
                                        ...
                                        onclick="toggleDropdownMenu('view-menu-{{ $user->id }}')" title="View Details">
                                    ...
                                    <div id="view-menu-{{ $user->id }}"
                                        ...
                                        <a href="{{ route('admin.users.show', $user) }}"
                                            class="flex items-center gap-3 px-4 py-3 text-sm text-slate-300 hover:bg-slate-700 hover:text-white transition border-b border-slate-700">
                                            <div
                                            ...
                                            <div class="flex-1">
                                                <div class="font-medium text-white">User Profile</div>
                                                <div class="text-xs text-slate-400">View account details</div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="{{ route('admin.hrm.employees.show', $employee) }}"
                                            class="flex items-center gap-3 px-4 py-3 text-sm text-slate-300 hover:bg-slate-700 hover:text-white transition border-b border-slate-700">
                                            <div
                                                class="flex-shrink-0 w-8 h-8 bg-teal-500/10 rounded-lg flex items-center justify-center">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-medium text-white">Employee Profile</div>
                                                <div class="text-xs text-slate-400">View HR details</div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="{{ route('admin.hrm.attendance.employee', $employee) }}"
                                            class="flex items-center gap-3 px-4 py-3 text-sm text-slate-300 hover:bg-slate-700 hover:text-white transition border-b border-slate-700">
                                            <div
                                                class="flex-shrink-0 w-8 h-8 bg-purple-500/10 rounded-lg flex items-center justify-center">
                                            ...
                                            <div class="flex-1">
                                                <div class="font-medium text-white">Timesheet</div>
                                                <div class="text-xs text-slate-400">View attendance</div>
                                            </div>
                                        </a>
                                        @endif
                                        ...
                                        <a href="{{ route('admin.users.edit', $user) }}"
                                            ...
                                            <div class="flex-1">
                                                <div class="font-medium text-white">Edit User</div>
                                                <div class="text-xs text-slate-400">Update account details</div>
                                            </div>
                                        </a>

                                        <!-- Password Options Header -->
                                        <div
                                            class="px-4 py-2 text-xs font-semibold text-slate-400 bg-slate-900/50 border-b border-slate-700">
                                            PASSWORD OPTIONS
                                        </div>
                                        ...
                                        <form action="{{ route('admin.users.destroy', $user) }}" method="POST">
                                            ...
                                            <button type="submit"
                                                ...
                                                class="w-full text-left px-4 py-3 text-sm text-red-400 hover:bg-red-500/10 hover:text-red-300 transition">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="flex-shrink-0 w-8 h-8 bg-red-500/10 rounded-lg flex items-center justify-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <div class="font-medium text-white">Delete User</div>
                                                        <div class="text-xs text-slate-400">Permanently remove</div>
                                                    </div>
                                                </div>
                                            </button>
                                        </form>
