                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center justify-end gap-1.5">
                                ...
                                <a href="{{ route('admin.hrm.employees.show', $employee) }}"
                                    class="inline-flex items-center justify-center w-8 h-8 bg-teal-500/10 text-teal-400 rounded-lg hover:bg-teal-500/20 transition"
                                ...
                                <a href="{{ route('admin.hrm.attendance.employee', $employee) }}"
                                    class="inline-flex items-center justify-center w-8 h-8 bg-purple-500/10 text-purple-400 rounded-lg hover:bg-purple-500/20 transition"
