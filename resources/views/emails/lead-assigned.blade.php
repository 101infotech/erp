            ...
            <div class="lead-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">
                        <a href="mailto:{{ $lead->email }}" style="color: #10b981; font-weight: 500;">{{ $lead->email }}</a>
                    </div>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">
                        <a href="tel:{{ $lead->phone_number }}" style="color: #10b981; font-weight: 500;">{{ $lead->phone_number }}</a>
                    </div>
                </div>
