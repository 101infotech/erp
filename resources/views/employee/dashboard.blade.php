<x-app-layout>
    <div class="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-slate-400 text-sm">{{ now()->format('l, F d, Y') }} • Last login: {{ $employee->user->last_login_at ? $employee->user->last_login_at->diffForHumans() : 'N/A' }}</p>
                    </div>
                    <a href="{{ route('employee.profile.show') }}" class="px-4 py-2 rounded-lg bg-lime-500 hover:bg-lime-600 text-slate-950 font-semibold text-sm transition">
                        View Profile
                    </a>
                </div>
                <div class="mt-4 p-4 bg-slate-800/30 rounded-lg border border-slate-700">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-lime-400">{{ $employee->department->name ?? 'No Department' }}</p>
                        </div>
                        <div>
            ...
            <!-- ========== QUICK STATS ========== -->
            <div class="mb-8">
                <h2 class="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Your Metrics</h2>
            <!-- ========== MAIN CONTENT GRID ========== -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <x-dashboard-card
                        ...
                        color="lime"
                        action="{{ route('employee.attendance.index') }}"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('employee.leave.create') }}" 
                                ...
                                <svg class="w-6 h-6 text-blue-400 mb-2 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                </svg>
                            ...
                            <a href="{{ route('employee.resource-requests.index') }}" 
                                ...
                                <svg class="w-6 h-6 text-purple-400 mb-2 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <x-dashboard-card
                    ...
                    color="amber"
                    action="{{ route('employee.announcements.index') }}"
                    actionLabel="View All"
                >
