    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6">
                        ...
                        <p class="text-slate-300 text-sm">
                            <span class="inline-flex items-center">
                                <svg class="w-4 h-4 mr-2 text-lime-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <span class="inline-flex items-center ml-2">
                                <svg class="w-4 h-4 mr-2 text-slate-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5.582a2 2 0 00-1.897 1.13A6 6 0 0112 21m0 0h6.582a2 2 0 001.897-1.13A6 6 0 0012 21m0 0H6.418A2 2 0 004.52 22.13a6 6 0 00.879-1.13m8 0a2 2 0 00-1.897-1.13h-5.582a2 2 0 00-1.897 1.13" />
                                </svg>
                                {{ $employee->department->name ?? 'No Department' }}
                            </span>
                        </p>
                        <p class="text-xs text-slate-500 mt-3">{{ now()->format('l, F d, Y') }} • Last login: {{
                ...
                <!-- Quick Action Card -->
                <div
                    class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 flex flex-col justify-center">
                    <div class="text-center">
                        <a href="{{ route('employee.profile.show') }}"
                            class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-lime-500/20 text-lime-400 mb-3 hover:bg-lime-500/30 transition">
                        ...
                        <a href="{{ route('employee.profile.show') }}"
                            class="text-lime-400 hover:text-lime-300 text-xs font-medium">View Full Profile →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                ...
                <div
                    class="group bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-5 border border-slate-700 hover:border-lime-500/30 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-10 h-10 rounded-lg bg-lime-500/20 flex items-center justify-center group-hover:bg-lime-500/30 transition">
                            <svg class="w-6 h-6 text-lime-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 13l2 2 4-4" />
                            </svg>
                        </div>
                ...
                <!-- Leave Balance -->
                <div
                    class="group bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-5 border border-slate-700 hover:border-blue-500/30 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/30 transition">
                ...
                <!-- Last Payment -->
                <div
                    class="group bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-5 border border-slate-700 hover:border-green-500/30 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-10 h-10 rounded-lg bg-green-500/20 flex items-center justify-center group-hover:bg-green-500/30 transition">
                    ...
                    <p class="text-2xl font-bold text-white mb-1">NPR {{
                ...
                <!-- Average Hours -->
                <div
                    class="group bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-5 border border-slate-700 hover:border-purple-500/30 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-10 h-10 rounded-lg bg-purple-500/20 flex items-center justify-center group-hover:bg-purple-500/30 transition">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div
                    class="lg:col-span-2 bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700 overflow-hidden">
                    <!-- Header -->
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    ...
                                    <svg class="w-5 h-5 text-slate-400 group-hover:text-lime-400 transition" fill="none"
                ...
                <div class="space-y-6">
                        ...
                        <div class="px-6 py-4">
                            ...
                            <div class="mb-3 last:mb-0 p-3 bg-slate-700/20 rounded-lg hover:bg-slate-700/30 transition">
                                <div class="flex items-center justify-between mb-2">
                                    <p class="text-white font-medium text-sm capitalize">{{ $leave->leave_type }} Leave
                                    </p>
                                    <span
                                        class="px-2 py-0.5 bg-yellow-500/20 text-yellow-400 rounded text-xs font-semibold">Pending</span>
                                </div>
                                <p class="text-xs text-slate-400">
                                    {{ \Carbon\Carbon::parse($leave->start_date)->format('M d') }} – {{
                                    \Carbon\Carbon::parse($leave->end_date)->format('M d') }} ({{ $leave->total_days }}
                                    days)
                                </p>
                            </div>
                            @empty
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('employee.leave.create') }}"
                            class="flex flex-col items-center justify-center p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg hover:border-blue-500/50 hover:bg-blue-500/15 transition text-center">
                        ...
                        <a href="{{ route('employee.resource-requests.index') }}"
                            class="flex flex-col items-center justify-center p-4 bg-purple-500/10 border border-purple-500/30 rounded-lg hover:border-purple-500/50 hover:bg-purple-500/15 transition text-center">
                            <svg class="w-6 h-6 text-purple-400 mb-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="px-6 py-4 space-y-3">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-lg bg-slate-700/50 flex items-center justify-center group-hover:bg-slate-700 transition">
                                    <svg class="w-5 h-5 text-slate-400 group-hover:text-green-400 transition"
