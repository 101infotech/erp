            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('employee.profile.show') }}"
                        class="px-4 py-2 rounded-lg bg-lime-500 hover:bg-lime-600 text-slate-950 font-semibold text-sm transition">
                        View Profile
                    </a>
                </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <a href="{{ route('employee.resource-requests.index') }}"
                                ...
                                <svg class="w-6 h-6 text-purple-400 mb-2 group-hover:scale-110 transition" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
