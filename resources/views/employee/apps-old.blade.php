    ...
    <div class="max-w-7xl mx-auto">
        ...
        @foreach($modules as $key => $module)
            ...
            <a href="{{ route($module['route']) }}"
                ...
                class="module-card group relative bg-gradient-to-br from-slate-800/80 to-slate-800/40 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50
                ...
                <div class="relative z-10">
                    ...
                    <!-- Module Info -->
                    <div class="mb-6">
                        <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-{{ $module['color'] }}-400 transition-colors">
                            {{ $module['name'] }}
                        </h3>
        ...
        <div class="mt-20 pt-12 border-t border-slate-700/30">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Available Apps -->
                <div class="group bg-gradient-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:scale-105">
                ...
                <!-- Today's Date -->
                <div class="group bg-gradient-to-br from-lime-500/10 to-lime-600/5 backdrop-blur-sm rounded-2xl p-6 border border-lime-500/20 hover:border-lime-500/40 transition-all duration-300 hover:scale-105">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-lime-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <!-- Status -->
                <div class="group bg-gradient-to-br from-green-500/10 to-green-600/5 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20 hover:border-green-500/40 transition-all duration-300 hover:scale-105">
                    <div class="flex items-center justify-between mb-4">
                ...
                <!-- User Info -->
                <div class="group bg-gradient-to-br from-purple-500/10 to-purple-600/5 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:scale-105">
                    <div class="flex items-center justify-between mb-4">
